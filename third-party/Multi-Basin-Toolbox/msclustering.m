function [stan_input, clstmodel] = msclustering(input, method, support, supportopt, options, voronoiopt, varargin)
...
switch method
    ...
    case 'T-MSC'
        [stan_input, clstmodel] = tmsc(input, support, supportopt, options);       
    case 'F-MSC'
